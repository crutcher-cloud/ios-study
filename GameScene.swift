...
//  lesson-8
//
//  Created by Влад Голосков on 22.07.2020.
...
extension GameScene: SKPhysicsContactDelegate {
    ...
    func gameContinue() {
        let alert = UIAlertController(title: "Game over :(", message: "Запустить снова?", preferredStyle: UIAlertController.Style.actionSheet)
